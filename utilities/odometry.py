...
from utilities.path_planner import BLOCK_KEEPOUT
from utilities.path_planner import MAP_EDGE_KEEPOUT
# for Odometer
...
class Odometer:
    ...
    def get_distance(self):
        with self.lock:
            return self.ticks_to_distance(self.left_ticks), self.ticks_to_distance(
                self.right_ticks
            )
...
class WorldMap:
    ...
    def draw_path_on_map(self, path: List[tuple], color):
